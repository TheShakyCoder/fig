...
var _sfc_main = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<p class="text-xs text-gray-500"> © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} Fig Limited </p></div></div></footer></div><!--]-->`);
		};
	}
};
